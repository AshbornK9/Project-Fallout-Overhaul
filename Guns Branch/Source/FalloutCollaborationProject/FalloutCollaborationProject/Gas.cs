...
namespace FalloutCollaborationProjectGas
{
    public class ThingThatAddsHediff : Gas
    {
        ...
        private void DoApplication()
        {
            ...
            thingsInGas = base.Position.GetThingList(base.Map);
            ...
            if (thingsInGas.Count == 0)
                return; //This causes a function to end
            ...
            //Go throughtthe list again as a clean up or you could just clear the list with:
            // touchingPawns.Clear();
